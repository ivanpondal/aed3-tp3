...
\subsection{Experimentación}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Aumento la cantidad de Nodos del cografo},
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Aumento la cantidad de Nodos del grafo completo},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
        ...
        \end{tikzpicture}
        \caption{Tiempos de ejecución observados al variar los valores de $n$
        ($k_n$) y de $N$ ($T_N$). Se considera $c_1 = 70$ y $c_2 = 10$.}
        \label{fig:exp3:var-nym-base}
    \end{figure}
     ...
     \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Aumento la cantidad de Nodos del grafo completo y del cografo},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
