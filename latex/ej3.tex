...
\subsection{Experimentación}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Se fija la cantidad de aristas en una  y aumento la cantidad de nodos ($n_1$) del cografo.},
                ...
                \addplot[color=red] table[x index=0, y expr={ 9 * (x*x) }]{../exp/ej3/cograph_k1_union_create_cotree};
                \legend{$T_{n_1}$,$ C * x^2 $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=red] table[x index=0, y expr={  125 * (x*x) }]{../exp/ej3/cograph_k3_union_create_cotree};
                \legend{$T_{n_1}$,$ C * x^2 $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=red] table[x index=0, y expr={ 9 * (x*x*x) }]{../exp/ej3/cograph_kn_create_cotree};
                \legend{$T_{n_1}$,$ C * x^3 $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
     ...
     \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=red] table[x index=0, y expr={ 900000 * (x) }]{../exp/ej3/cograph_kn_dp};
                \legend{$T_{n_1}$,$ C * x $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
     ...
     \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=red] table[x index=0, y expr={ 900000 }]{../exp/ej3/cograph_kn_dp};
                \legend{$T_{n_1}$,$ C * x $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/cograph_k1_union_dp};
                \addplot[color=red] table[x index=0, y expr={ 5000 * (x) }]{../exp/ej3/cograph_k1_union_dp};
                \legend{$T_{n_1}$,$ C * x $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/cograph_k3_union_dp};
                \addplot[color=red] table[x index=0, y expr={ 5* (x) }]{../exp/ej3/cograph_k3_union_dp};
                \legend{$T_{n_1}$,$ C * x $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Vario la cantidad de nodos del cografo ($n_1$) },
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/cograph_incremental_nodes};
                \addplot[color=red] table[x index=0, y expr={  2500 * (x*x)  }]{../exp/ej3/cograph_incremental_nodes};

                \legend{$T_{(co_n)}$, $ C * x^2 $}
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Vario la cantidad de nodos del grafo completo ($n_2$)},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/complete_graph_incremental_nodes};

                \legend{$T_{(k_n)}$}
            \end{axis}
        \end{tikzpicture}
        \caption{Tiempos de ejecución observados al variar los valores de $n_2$
        ($(k_n)$) .}
        \label{fig:exp3:var-nym-base}
    \end{figure}
     ...
     \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Aumento la cantidad de nodos ($n_1$) del grafo completo y del cografo ($n_2$)},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/complete_graph_and_cograph_incremental_nodes};
                \addplot[color=red] table[x index=0, y expr={ 8 * (x*x*x) }]{../exp/ej3/complete_graph_and_cograph_incremental_nodes};

                \legend{$T_{(k_n y co_n)}$, $ C * x^3$}
            \end{axis}
        \end{tikzpicture}
        \caption{Tiempos de ejecución observados al variar los valores de $n_1$ y  $n_2$
        ($T_{(k_n y co_n)}$).}
        \label{fig:exp3:var-nym-base}
    \end{figure}
     ...
     \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Fijo el $K_n$ ($n_1$)y la cantidad de nodos del cografo ($n_2$)y aumento la cantidad de aristas del cografo.},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/cograph_incremental_edges};
                \addplot[color=red] table[x index=0, y expr={  (19000000 * x) + 9000000 ) }]{../exp/ej3/cograph_incremental_edges};

                \legend{$T_{m_2}$,$ C * x $ }
            \end{axis}
        \end{tikzpicture}
        \caption{Tiempos de ejecución observados al fijar el $K_n$ ($n_1$)y la cantidad de nodos del cografo ($n_2$) y variar la probabilidad de hacer un join al crear el cografo. Variamos la probabilidad entre $0 y 1$ y la llamamos $c$}
        \label{fig:exp3:var-nym-base}
    \end{figure}
     ...
     \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Fijo el cografo y vario la cantidad de nodos del $K_n$ ($n_2$), ejecuto solo la resolución del DP},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/complete_graph_incremental_nodes_dp};
                \addplot[color=red] table[x index=0, y expr={  1200 * (x*x)  }]{../exp/ej3/complete_graph_incremental_nodes_dp};
    ...
    \end{figure}
       ...
       \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Vario el cografo ($n_1$) y fijo la cantidad de nodos del $K_n$, ejecuto solo la resolución del DP},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/cograph_incremental_nodes_dp};
                \addplot[color=red] table[x index=0, y expr={  190000 * x ) }]{../exp/ej3/cograph_incremental_nodes_dp};
