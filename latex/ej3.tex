...
\subsection{Experimentación}
    ...
    Se experimentó con la creación del cotree y con la resolución del DP por separado para tener un mayor control de las variables.
   ...
   \begin{enumerate}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Se ejecuto la resolución del DP. Como $n_2 = n_1/2$, queda una complejidad $O(n_1* (n_1/2)^2)$ = $O(n_1^3)$.}
        \label{fig:exp3:var-nym-base}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Se ejecuto la resolución del DP. Como $n_2 = ln(n_1)$, queda una complejidad $O(n_1 * ln^2(n_1))$.}
        \label{fig:exp3:var-nym-base}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Se ejecuta la creación del coarbol. como $m_2 = 0$, queda una complejidad $O(n_1(n_1 + 0))$ = $O(n_1^2$.}
        \label{fig:exp3:var-nym-base}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Se ejecuta la creación del cotree. Como $m_1 = n_1$, queda una complejidad $O(n_1(n_1 + n_1))$ = $O(n_1^2)$}
        \label{fig:exp3:var-nym-base}
    \end{figure}
