...
\subsection{Experimentación}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Fijo la cantidad de nodos del cografo ($n_1$) y aumento la cantidad de aristas del cografo.},
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/cograph_incremental_edges_create_cotree};
                \addplot[color=red] table[x index=0, y expr={  500000 * ((x*x) * 200) }]{../exp/ej3/cograph_incremental_edges_create_cotree};
                \legend{$T_c$, $ C * x^2 $}
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/ej3/cograph_incremental_nodes_create_cotree};
                \addplot[color=red] table[x index=0, y expr={ 3 * (x*x) }]{../exp/ej3/cograph_incremental_nodes_create_cotree};
                \legend{$T_{n_1}$,$ C * x^2 $}
            \end{axis}
        \end{tikzpicture}
        \caption{lalala Solo ejecuto la creación del cotree}
