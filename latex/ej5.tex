...
%    posible, dar una cota superior para la cantidad de iteraciónes de la
%    heurística.
...
iteraciónes. El ciclo interior recorre el conjunto $W_U \subseteq G_2$ de los
...
iteraciónes menor (se puede decir que $N_2$ es una vecindad más
...
\begin{itemize}
    ...
    combinada de estas iteraciónes, considerando por separado las operaciones
...
Sumando la complejidad de los tres tipos de iteraciónes recién descriptos, se
...
\subsection{Experimentación}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un ciclo de 300 nodos y $g2$ es un random tree de 600 .}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un random tree de 300 nodos y $g2$ es un ciclo de 600.}
        \label{fig:exp5:var-pym-base}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un bipartito  300 nodos con promedio de arristas de $0.5$ y  $g2$ es un random tree de 600.}
    ...
    \end{figure}
      ...
      \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un bipartito  300 nodos con promedio de arristas de $0.5$ y $g2$ es un ciclo de 600.}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un bipartito  300 nodos con promedio de arristas de $0.5$ y $g2$ es un completo de 150.}
	...
	\subsubsection{Cantidad de iteraciónes optima}

    Dadas familias con orden $n$(tree, ciclo) de arristas y orden $n^2$,(bipartito, completo) se varia la cantidad de iteraciónes maximas de la busqueda local.
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un ciclo de 300 nodos y $g2$ es un random tree de 600 nodos.}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un random tree de 300 nodos y $g2$ es un ciclo de 600 nodos.}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un bipartito  300 nodos con promedio de arristas de $0.5$ y $g2$ es un random tree de 600 nodos. }
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{$g1$ es un bipartito  300 nodos con promedio de arristas de $0.5$ y $g2$ es un ciclo de 600 nodos.}
    ...
    Se corrieron con viendo el $5$ porciento de la vecindad y cortando a la 5 iteración.
