    ...
    \begin{tikzpicture}[baseline]
        \begin{axis}[
            ...
            \addplot[color=green] table[x index=0,y index=1]
                {../exp/ej5/big_cicle_vs_small_tree_neighbourhood_1_proportion};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[baseline]
        \begin{axis}[
            ...
            \addplot[color=green] table[x index=0,y index=1]
                {../exp/ej5/big_cicle_vs_small_tree_neighbourhood_2_proportion};
            \addplot[color=red] table[x index=0,y index=1]
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[baseline]
        \begin{axis}[
            ...
            \addplot[color=orange, mark=*] table[x index=0,y index=1]
                {../exp/ej5/big_tree_vs_small_cicle_neighbourhood_1_iteration};
            \addplot[color=green, mark=*] table[x index=0,y index=1]
                {../exp/ej5/big_cicle_vs_small_tree_neighbourhood_1_iteration};
            \addplot[color=red, mark=*] table[x index=0,y index=1]
    ...
    \begin{tikzpicture}[baseline]
        \begin{axis}[
            ...
            \addplot[color=violet, mark=*] table[x index=0,y index=1]
...
Se corrio la primera vecindad con 100 iteraciones como máximo y viendo $0.2\%$ de la vecindad, la segunda con $50$ iteraciones como máximo y viendo $0.2\%$ de la vecindad.
...
Se puede concluir que para grafos en muy parecidos en cardinalidad de nodos la primera vecindad devuelve una solución mala, pero tarda muy poc. Aumentado la cantidad de iteraciones máximas se esperaría una mejor solución. 

La segunda vecindad devuelve una buena solución ya que al poder hacer permutaciones aumenta los candidatos a probar.
...
En linea general la primera vecindad tiene una mejor solución y tarda menos que la segunda, ya que la segunda tarda más por iteración, en lo cual prueba menos nodos.


Se puede concluir que para grafos con una diferencia razonable de nodos (sea la la mitad o el doble de nodos) la primera vecindad es notablemente mejor que la segunda.