...
bool mcs_backtracking(
    ...
    if (!remaining_g1_nodes.empty() && !remaining_g2_nodes.empty()) {
        ...
        for (int remaining_g1_index = 0; remaining_g1_index < remaining_g1_nodes.size(); remaining_g1_index++) {
            for (int remaining_g2_index = 0; remaining_g2_index < remaining_g2_nodes.size(); remaining_g2_index++) {

                cout << "r1 " << remaining_g1_index << " r2 " << remaining_g2_index << endl;
                ...
                for (int neighbour_index = 0; neighbour_index < g1_neighbours.size(); neighbour_index++) {
